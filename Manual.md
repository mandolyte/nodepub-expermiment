...
:   Enables inclusion of most of the [CSS] in the `styles.html`
    [partial](Manual.md#partials) (have a look with
    `pandoc --print-default-data-file=templates/styles.html`).
    Unless you use [`--css`](Manual.md#option--css), this variable
...
`classoption`
:   when using [KaTeX](Manual.md#option--katex), you can render display
math equations flush left using [YAML metadata](Manual.md#layout) or with
`-M classoption=fleqn`.
...
The extensions [`tex_math_dollars`](Manual.md#extension-tex_math_dollars),
[`tex_math_single_backslash`](Manual.md#extension-tex_math_single_backslash), and
[`tex_math_double_backslash`](Manual.md#extension-tex_math_double_backslash)
...
- [`raw_html`](Manual.md#extension-raw_html) allows HTML elements which
  are not representable in pandoc's AST to be parsed as raw HTML.
  By default, this is disabled for HTML input.

- [`raw_tex`](Manual.md#extension-raw_tex) allows raw LaTeX, TeX, and ConTeXt
...
- [`native_divs`](Manual.md#extension-native_divs) causes HTML `div`
...
- [`native_spans`](Manual.md#extension-native_spans) causes HTML `span`
...
This can be used with [docx custom styles](Manual.md#custom-styles).
Disabled by default.
...
Some aspects of [Pandoc's Markdown citation syntax](Manual.md#citations)
...
See also the [](Manual.md#extension-auto_identifiers) above.
...
the [`raw_attribute` extension](Manual.md#extension-raw_attribute)), or it
...
[`raw_attribute` extension](Manual.md#extension-raw_attribute).
...
[`link_attributes`](Manual.md#extension-link_attributes) extension.
...
By enabling the [`styles` extension](Manual.md#ext-styles) in the docx reader
